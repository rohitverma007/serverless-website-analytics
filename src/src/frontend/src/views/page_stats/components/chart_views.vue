...
function changePeriod(value: "hour" | "day") {
  period.value = value;
  loadData();
}
...
async function loadData()
{
  ...
  let periodValue: "hour" | "day" = period.value;
  if(daysBetween < 3 && periodValue != "hour")
    periodValue = "hour";
...
<template>
  <div class="container" style="height: 470px;">
    <div v-show="!loading" style="position: relative; padding: 10px;">
      ...
      <el-dropdown class="chart_selector" trigger="click" @command="changePeriod" style="margin-right: 100px;">
      <span>
        {{period}}
        <el-icon style="top: 2px;"> <arrow-down /> </el-icon>
      </span>
